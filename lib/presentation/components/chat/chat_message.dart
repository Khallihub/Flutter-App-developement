            ...
            child: ListTile(
              onTap: () {
                ...
                GoRouter.of(context).pushNamed(
                  ...
                  pathParameters: {
                    "id": chats[index].id,
                    "user1": chats[index].users[0] == chats[index].userName ? chats[index].users[1] : chats[index].users[0],
              ...
              trailing: Text(
                DateTime.fromMillisecondsSinceEpoch(int.parse(chats[index].lastMessage[0])).toString() ,
                style: Theme.of(context).textTheme.bodySmall,
              ),
            ),
          );
