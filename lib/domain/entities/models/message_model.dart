class Message {
  ...
  static List<Message> messages = [
    Message(
      ...
      createdAt: DateTime(2023, 06, 01, 10, 10, 10),
    ),
    Message(
      senderId: '1',
      recipientId: '2',
      text: 'I am staying here today.',
      createdAt: DateTime(2023, 06, 01, 10, 10, 10).add(
    ...
    Message(
      ...
      recipientId: '5',
      text: 'Hey, how are you?',
      createdAt: DateTime(2023, 06, 01, 10, 10, 20),
    ),
    Message(
      senderId: '1',
      recipientId: '6',
      text: 'Hey, how are you?',
      createdAt: DateTime(2023, 06, 01, 10, 10, 40),
    ),
  ];
}
