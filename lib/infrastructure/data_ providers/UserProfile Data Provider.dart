...
class UserProfileDataProvider {
  static const String baseUrl =
      'http://127.0.0.1:3000/post'; // Replace with your API base URL

  Future<UserProfile> fetchUserProfile(String userId) async {
    final response =
        await http.get(Uri.parse('$baseUrl/users/$userId/profile'));
  ...
  Future<void> updateUserProfile(UserProfile userProfile) async {
    ...
    final response =
        await http.put(Uri.parse(profileUrl), body: body, headers: {
